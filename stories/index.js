...
storiesOf("InterviewerListItem", module)
  ...
  .add("Clickable", () => (
    <InterviewerListItem
      ...
      name={interviewer.name}
      avatar={interviewer.avatar}
      //was: setInterview={action("setInterviewer")}
...
storiesOf("Appointment", module)
  ...
  .add("Form/Edit", () => <Form name="Sylvia Palmer" interviewers={interviewers} interviewer={interviewer.id} onSave={action("onSave")} onCancel={action("onCancel")} />)
